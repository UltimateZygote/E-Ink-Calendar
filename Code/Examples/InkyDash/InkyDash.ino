...
/* SPI Settings */
//GxIO_Class io(SPI, /*CS=*/ 15, /*DC=*/ 27, /*RST=*/ 26); // arbitrary selection of D3(=0), D4(=2), selected for default of GxEPD_Class
//GxEPD_Class display(io, /*RST=*/ 26, /*BUSY=*/ 25); // default selection of D4(=2), D2(=4)
...
const String lat = "35.30522854185029";
const String lon = "-120.66252639018634";
...
void drawHomeFrame(const void* p) {
...
void datetimeUpdateCallback() {
  ...
  display.drawPaged(drawHomeFrame, &cursor);
}
...
const char* getRandomNtpServer(const char* ntpServers[]) {
  int randomIndex = random(ntpServerCounts - 1);
  //int randomIndex = 0;
